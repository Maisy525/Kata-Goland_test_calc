...
const (
	LOW = "PANIC: " +
		"Указанная операция не относится к допустимым."
	HIGH = "PANIC: " +
	...
	ZERO  = "PANIC: " + "в римской системе нет числа 0."
	RANGE = "PANIC: " + "мы работаем только с арабскими целыми арабскими числами или римскими цифрами от 1 до 10 включительно"
)
...
func main() {
	fmt.Println("Добрый день. Введите операцию, реузльтат которой хотите узнать. Доступные операции - сложение, умножение, вычитание и " +
		"деление двух арабских чисел или римских цифр от 1 до 10.")
